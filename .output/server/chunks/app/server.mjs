...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-3e0d31f8.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/login-f9ee824a.mjs').then((m) => m.default || m)
  }
];
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_main, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="el-page-main" data-v-ee6f7632${_scopeId2}>`);
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ee6f7632"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-4cd00e2a.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-a4d7c3ec.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { vLoading as A, componentSizes as B, formContextKey as C, useId as D, ElIcon as E, getProp as F, view_default as G, hide_default as H, circle_close_default as I, useRouter as J, ElButton as K, useGlobalComponentSettings as L, TypeComponents as M, isElement as N, withInstallFunction as O, navigateTo as P, _export_sfc as Q, useHead as R, TypeComponentsMap as T, ValidateComponentsMap as V, _export_sfc$1 as _, addUnit as a, buildProps as b, createError as c, definePropType as d, entry$1 as default, debugWarn as e, useSizeProp as f, useFormDisabled as g, useFormItem as h, isUndefined as i, useFormSize as j, useFormItemInputId as k, withNoopInstall as l, addClass as m, loading_default as n, caret_right_default as o, iconPropType as p, useLocale as q, removeClass as r, formItemContextKey as s, throwError as t, useNamespace as u, download_default as v, withInstall as w, ElContainer as x, ElAside as y, ElMain as z };
