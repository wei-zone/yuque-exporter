import { reactive, getCurrentInstance, version, unref, inject, ref, watchEffect, watch, toRef, isRef, nextTick, shallowRef, computed, isReadonly, openBlock, createElementBlock, createElementVNode, warn, provide, defineComponent, mergeProps, renderSlot, onUnmounted, useSlots, Text, normalizeClass, normalizeStyle, Fragment as Fragment$1, createBlock, withCtx, resolveDynamicComponent, createCommentVNode, createApp, toRefs, h, Transition, withDirectives, createVNode, vShow, Suspense, createTextVNode, useSSRContext, onErrorCaptured, onServerPrefetch, defineAsyncComponent } from "vue";
...
import { isString, camelize, isObject, hasOwn, NOOP, hyphenate } from "@vue/shared";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-5acf838c.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/login-f9ee824a.js").then((m) => m.default || m)
  }
];
...
const app_vue_vue_type_style_index_1_scoped_ee6f7632_lang = "";
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-4cd00e2a.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-a4d7c3ec.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export {
  ...
  view_default as G,
  hide_default as H,
  circle_close_default as I,
  useRouter as J,
  ElButton as K,
  useGlobalComponentSettings as L,
  TypeComponents as M,
  isElement as N,
  withInstallFunction as O,
  navigateTo as P,
  _export_sfc as Q,
  useHead as R,
  ...
  debugWarn as e,
  useSizeProp as f,
  useFormDisabled as g,
  useFormItem as h,
  isUndefined as i,
  useFormSize as j,
  useFormItemInputId as k,
  withNoopInstall as l,
  addClass as m,
  loading_default as n,
  caret_right_default as o,
  iconPropType as p,
  useLocale as q,
  removeClass as r,
  formItemContextKey as s,
  throwError as t,
  useNamespace as u,
  download_default as v,
  withInstall as w,
  ElContainer as x,
  ElAside as y,
  ElMain as z
