globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+node-fetch-native@1.1.0/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+std-env@3.3.2/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getHeaders, readBody, sendStream, getQuery, createError } from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+h3@1.6.4/node_modules/h3/dist/index.mjs';
import dayjs from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+dayjs@1.11.7/node_modules/dayjs/dayjs.min.js';
import yaml from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+yaml@2.2.1/node_modules/yaml/dist/index.js';
import JSZip from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+jszip@3.10.1/node_modules/jszip/lib/index.js';
import axios from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+axios@1.3.5/node_modules/axios/index.js';
import { createRenderer } from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+vue-bundle-renderer@1.0.3/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+@nuxt+devalue@2.0.0/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+vue@3.2.47/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+ofetch@1.0.1/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+destr@1.2.2/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+unenv@1.2.2/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+scule@1.0.0/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+defu@6.1.2/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+ohash@1.0.0/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+ufo@1.1.1/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+unstorage@1.4.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+unstorage@1.4.1/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/forguo/work/wei/projects/yuque-exporter/node_modules/.pnpm/registry.npmmirror.com+radix3@1.0.1/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/forguo/work/wei/projects/yuque-exporter/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/forguo/work/wei/projects/yuque-exporter","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/forguo/work/wei/projects/yuque-exporter/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/forguo/work/wei/projects/yuque-exporter/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/forguo/work/wei/projects/yuque-exporter/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_EXedd6 = () => Promise.resolve().then(function () { return docs_post$1; });
const _lazy_xiH8l4 = () => Promise.resolve().then(function () { return _export$1; });
const _lazy_xPb7wR = () => Promise.resolve().then(function () { return repos$1; });
const _lazy_K8Q3X8 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/docs', handler: _lazy_EXedd6, lazy: true, middleware: false, method: "post" },
  { route: '/api/export', handler: _lazy_xiH8l4, lazy: true, middleware: false, method: undefined },
  { route: '/api/repos', handler: _lazy_xPb7wR, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_K8Q3X8, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_K8Q3X8, lazy: true, middleware: false, method: undefined }
];
...
const docs_post$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: docs_post
});
...
const repos$1 = /*#__PURE__*/Object.freeze({
      __proto__: null,
      default: repos
});
...
const getClientManifest = () => import('/Users/forguo/work/wei/projects/yuque-exporter/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/forguo/work/wei/projects/yuque-exporter/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<title>语雀导出</title>\n<meta name=\"author\" content=\"forguo, wforguo\">\n<meta name=\"baidu-site-verification\" content=\"code-bakUos2v8l\">\n<meta name=\"google-site-verification\" content=\"9aVJNYlDCl0rCI1akpdSqg9Xwr47KJrVWSXktSsfwKE\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta name=\"description\" content=\"语雀，语雀文档导出，语雀文档批量导出，语雀批量导出，wforguo，forguo\">\n<meta name=\"keywords\" content=\"语雀|语雀文档导出|语雀文档批量导出|语雀批量导出|wforguo|forguo\">\n<script src=\"https://hm.baidu.com/hm.js?2788f1f4f01e060d6d892f4bbd5b74d4\"></script>","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
